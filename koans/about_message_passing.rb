...
class AboutMessagePassing < Neo::Koan
  ...
  def test_send_with_underscores_will_also_send_messages
    ...
    # send may be used in a different context, while __send__ can be used in all objects
    # same with Id and Object_Id, ID came first, but realized ID are used in many different ways.
  end
